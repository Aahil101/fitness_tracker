...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  // Bordered as well as filled: on the soft surfaces this sits on, the tonal
  // background alone is too close to the page to read as a control.
  tonal:
    'border border-md-outline-variant bg-md-secondary-container text-md-on-secondary-container hover:bg-md-secondary-container/80 active:bg-md-secondary-container/70 hover:shadow-e1',
  outlined:
  ...
  elevated:
    'border border-md-outline-variant bg-md-surface-container-low text-md-info shadow-e1 hover:shadow-e2 hover:bg-md-info/[0.06]',
