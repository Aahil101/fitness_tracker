...
CATEGORY_CONFLICTS = (
    ...
    "cat food",
    "sauce, ",
    # Composite prepared dishes. A plain-ingredient query must not be answered
    # with something built around it: "grilled fish" matched "Fish sandwich,
    # grilled" and priced a fillet at sandwich density.
    "sandwich",
    "burger",
    "pizza",
    "wrap",
